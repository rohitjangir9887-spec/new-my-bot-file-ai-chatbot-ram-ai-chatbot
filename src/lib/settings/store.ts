...
interface SettingsState {
  ...
  webSearchEnabled: boolean; safeSearch: boolean;
  ...
  setMemoryEnabled: (enabled: boolean) => void; setPersonalizationEnabled: (enabled: boolean) => void; setCustomInstructions: (instructions: string) => void; setLanguage: (lang: string) => void; setHasCompletedOnboarding: (completed: boolean) => void; setWebSearchEnabled: (enabled: boolean) => void; setSafeSearch: (enabled: boolean) => void;
}
...
export const useSettingsStore = create<SettingsState>()(persist((set) => ({
  ...
  memoryEnabled: true, personalizationEnabled: true, customInstructions: '', language: 'English (US)', hasCompletedOnboarding: false, webSearchEnabled: true, safeSearch: true,
